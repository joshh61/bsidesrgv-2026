    ...
    <section id="cfp" className="relative overflow-hidden bg-navy text-paper">
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-24 sm:py-32">
        ...
        <div className="mt-12 grid gap-x-14 gap-y-14 lg:grid-cols-[1.15fr_0.85fr]">
          <Reveal variant="clip">
            <span className="inline-flex items-center gap-2 bg-gold/15 px-3 py-1.5 font-mono text-xs font-medium uppercase tracking-[0.16em] text-gold-soft">
            ...
            <div className="mt-9 border-t border-paper/15 pt-7">
              <p className="font-mono text-xs font-medium uppercase tracking-[0.18em] text-paper/75">
                Submissions close
              </p>
          ...
          <Reveal delay={0.1}>
            ...
            <ul className="mt-6 flex flex-col">
              {callForPresentations.details.map((detail) => (
                <li
                  key={detail}
                  className="flex gap-3.5 border-b border-paper/12 py-4 text-lg leading-relaxed text-paper/90"
                >
          ...
          <div className="mt-16 border-t border-paper/15 pt-8">
            ...
            <p className="mt-5 flex flex-wrap items-center gap-x-1.5 gap-y-2">
              {talkTopicExamples.map((topic, i) => (
                <span key={topic} className="font-display text-xl text-paper/90 sm:text-2xl">
                  {topic}
        ...
        <Reveal variant="scale">
          <div className="mt-12 border-l-2 border-ember pl-6">
            ...
            <p className="mt-2 max-w-2xl text-lg leading-relaxed text-paper/90">
